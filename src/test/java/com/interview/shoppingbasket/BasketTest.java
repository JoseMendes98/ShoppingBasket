...
public class BasketTest {
    ...
    void consolidateBasketTest() {
        ...
        assertEquals(basketItems.get(0).getProductName(), "myProduct");
        assertEquals(basketItems.get(0).getQuantity(), 40);

        assertEquals(basketItems.get(1).getProductCode(), "productCode2");
        assertEquals(basketItems.get(1).getProductName(), "myProduct2");
        assertEquals(basketItems.get(1).getQuantity(), 20);
    }
}
